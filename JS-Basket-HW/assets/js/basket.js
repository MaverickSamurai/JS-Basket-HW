...
for (const product of products) {
    ...
    <td>${product.desc}</td>
    <td>${product.count}</td>
    <td class= "my-icon"><i class="fa-solid fa-circle-xmark" ></i></td>
  </tr>`
}
...
let deleteIcon = document.querySelectorAll(".my-icon");
...
deleteIcon.forEach(element => {
    element.addEventListener("click",function(e){
        ...
        localStorage.clear(); 
        document.querySelector("sup").innerText = getProductsCount.remove(products);
